...
{	
    ...
    $conn = new mysqli ($host, $dbusername, $dbpassword, $dbname, 3308);		//makes connection to the database, using the provided database information.
        ...
        $result = mysqli_query($conn, $sql);
            ...
            if($conn->query($sql))		
            {
                ...
                if($count != 0)
                {
                    ...
                    $sql2 = "INSERT INTO medicalform(firstname, lastname, gender, disabilities, Allergies, the_Disabilities, the_Allergies, performed_by) VALUES ('$firstname', '$lastname', '$gender', '$disability', '$allergies', '$disa', '$alle', '$idnumber')";		//SQL code that writes data into the database.
