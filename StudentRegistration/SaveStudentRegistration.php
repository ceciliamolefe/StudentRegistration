<?php
    ...
    {	
                ...
                { 
                        $sql = "INSERT INTO applications(firstname, lastname, idnumber, gender, contact, address, course, studyYear, modeofstudy, prefferedcampus, status, paid) VALUES ('$firstname', '$lastname', '$idnumber', '$gender', '$contact', '$address', '$course', '$Studyyear', '$modeofstudy', '$campus', 'pending', 'No')";		//SQL code that writes data into the database.
                        ...
                        //     header( "Refresh:0; url=NewUser.php", true, 303);
                            ...
                            $sql2 = "INSERT INTO students(username, password, idnumber) VALUES ('$uname', '$password', '$idnumber')";		//SQL code that writes data into the database.
